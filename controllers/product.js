...
function saveProduct(req, res){
    ...
    product.nameProject = req.body.nameProject
    product.date = req.body.date 
    product.committee = req.body.committee
    product.typeProject = req.body.typeProject
    product.benefited = req.body.benefited
